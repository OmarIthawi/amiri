...
feature calt {
  sub [uni065C] [uni0650]' by [uni0650.small2];
} calt;
...
feature calt {
  lookupflag IgnoreMarks;
  ignore sub [uni0649.init uni0649.medi]' @aHeh.medi';
...
feature calt {
  sub @aLam.init' lookup LamKafInit [uni0653 uni06E4]
      @aMem.medi [uni0653 uni06E4];
} calt;
